...
class RedisStreamReader:
    def __init__(self, redis_host='localhost', redis_port=6379, stream_name='mystream', consumer_group='mygroup', consumer_name='myconsumer'):
    ...
    def read_one_streams(self):
        try:
            ...
            streams_with_start = [(stream, self.last_delivery_id(stream)) for stream in self.streams]
